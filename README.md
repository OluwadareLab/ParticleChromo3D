...
-----------------------------------------------------------	
<ul> src: Python Source Code and utility's used. <br />
<ul> input-and-models: Synthetic and Real Hi-C datasets used. <br />
<ul> Results: Output Structions generated for all the experiemnts performed.<br />
